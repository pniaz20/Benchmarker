...
Benchmarker::Benchmarker() :
	...
	tempDurSec(0.0)
{
	std::cout << "Benchmarker constructed by default with number of repetitions of 1.\n";
}

Benchmarker::Benchmarker(unsigned long numrepts) :
	start(std::chrono::system_clock::now()),
	stop(std::chrono::system_clock::now()),
	startTotal(std::chrono::system_clock::now()),
	stopTotal(std::chrono::system_clock::now()),
...
double Benchmarker::getSingleDur(int ident) {
	if (isActive) {
...
vector<double> Benchmarker::getDurations(int ident) {
	if (isActive) {
...
void Benchmarker::report(int ident) {
	cout.precision(20);
	cout << endl;
	cout << "-----------------------------------------------------------------------------------" << endl;
